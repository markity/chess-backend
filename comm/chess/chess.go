...
func NewChessTable() *ChessTable {
	...
	table.SetPosition(&ChessPiece{X: 'd', Y: 1, PieceType: ChessPieceTypeKing, GameSide: SideWhite, Moved: false})
	table.SetPosition(&ChessPiece{X: 'e', Y: 1, PieceType: ChessPieceTypeQueen, GameSide: SideWhite, Moved: false})
	...
	table.SetPosition(&ChessPiece{X: 'd', Y: 8, PieceType: ChessPieceTypeKing, GameSide: SideBlack, Moved: false})
	table.SetPosition(&ChessPiece{X: 'e', Y: 8, PieceType: ChessPieceTypeQueen, GameSide: SideBlack, Moved: false})
